...
In this project, I seek to develop two deep learning models (NHITS, LSTM) that will forecast a set of 9 stocks' closing prices. By incorporating a base investment amount and corresponding weights for each asset, my ultimate objective is to:
